    ...
    return (
        <div>
            ...
            <div className="financementHome">
                <span className='h3'>Financement à <span>100%</span> de vos formations : saisissez l'opportunité dès maintenant !</span>
