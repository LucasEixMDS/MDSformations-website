...
const Formation_certification = ({ formation }) => {
    ...
    return (
        ...
        <div className="certification">
            ...
            <p><img src={cible} alt="icon d'un parchemin" />Avancez avec Confiance : Élevez votre expertise et votre carrière grâce à notre accréditation reconnue.</p>
            <p><img src={trophy} alt="icon d'un parchemin" />Excellence Récompensée : Notre certification est le gage de votre engagement envers l'apprentissage continu et la maîtrise de votre domaine.</p>
        </div>
