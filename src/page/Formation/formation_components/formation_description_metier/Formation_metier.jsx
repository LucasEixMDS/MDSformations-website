          ...
          {objectivesList.map((objective, index) => (
              <li key={index}>
                  <svg width="20" height="21" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <g id="Group">
                          <path id="Vector" d="M9.96094 20.5164C15.4102 20.5164 19.9219 16.0107 19.9219 10.5902C19.9219 5.16003 15.4004 0.664062 9.95117 0.664062C4.51172 0.664062 0 5.16003 0 10.5902C0 16.0107 4.52148 20.5164 9.96094 20.5164Z" fill={svgColor || "#7BC8CB"} /> {/* La couleur peut être modifiée ici */}
